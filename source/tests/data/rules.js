...
export const tests = [
  ...
  [32, 'Багато упорядників!', 'Багато упорядниць!', correctionTypes.UNCERTAIN, true], /* банник-банниця */
  [32, 'Що це значить — бути кур’єром?', 'Що це значить — бути кур’єркою?', correctionTypes.UNCERTAIN, true], /* ант-антка */
