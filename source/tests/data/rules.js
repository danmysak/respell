...
export const tests = [
  ...
  [51, 'Глянь-но, видно Альфу Малої Ведмедиці!', 'Глянь-но, видно альфу Малої Ведмедиці!', correctionTypes.UNSURE],
  [51, 'Це Бета Андромеди, вона дуже яскрава.', 'Це бета Андромеди, вона дуже яскрава.', correctionTypes.UNSURE],
  [51, 'Побачила я за своє життя двійко Гамм Ведмедиць', 'Побачила я за своє життя двійко гамм Ведмедиць', correctionTypes.UNSURE],
  [51, 'Завдячую цим Омезі Рака :-)', 'Завдячую цим омезі Рака :-)', correctionTypes.UNSURE],
  [51, 'Гей ти, Епсилоне Кассіопеї, підлітай!', 'Гей ти, епсилоне Кассіопеї, підлітай!', correctionTypes.UNSURE],
  [51, 'Це все Псі Летючої Риби постарався.', 'Це все псі Летючої Риби постарався.', correctionTypes.UNSURE],
  ...
  [54, 'Користувач твіттера, проаналізувавши дані з "Гугла", заявила: "не вірю "Твіттеру і Гуглу".', 'Користувач твітера, проаналізувавши дані з ґуґла, заявила: "не вірю "твітеру і ґуґлу".', [correctionTypes.MISTAKE, correctionTypes.MISTAKE, correctionTypes.MISTAKE, correctionTypes.MISTAKE, correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE], false, 2],
  [54, 'Він відкрив для себе вебплатформу для фотообміну інстаграм (платформу для фотообміну Інстаграм або суперплатформу для фотообміну «інстаграм»).', 'Він відкрив для себе вебплатформу для фотообміну «Інстаграм» (платформу для фотообміну «Інстаграм» або суперплатформу для фотообміну «Інстаграм»).', [correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [54, 'Відеохостинг Ютюба кращий за хостинг відео вімео', 'Відеохостинг «Ютюба» кращий за хостинг відео «Вімео»', [correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [54, 'СЕРВІСИ ВІКІПЕДІЇ гірші за Сервіси нового "вікшинарі"', 'СЕРВІСИ «ВІКІПЕДІЇ» гірші за Сервіси нового "Вікшинарі"', [correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [54, 'Ці сервіси подібні до "вікшинарі"', 'Ці сервіси подібні до вікшинарі', correctionTypes.UNSURE],
  [54, 'Це сервіс „Вікіпедії“, а не «„сервіс“ Вікіпедії».', 'Це сервіс „Вікіпедії“, а не «„сервіс“ «Вікіпедії»».', correctionTypes.UNSURE],
  [54, 'Нетфлікс проти сайтів Амазона. Ура! Нетфлікс! Наш Нетфлікс, цей (Нетфлікс)... Нетфлікс. (Нетфлікс) це.', 'Нетфлікс проти сайтів «Амазона». Ура! Нетфлікс! Наш нетфлікс, цей (нетфлікс)... Нетфлікс. (Нетфлікс) це.', [correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [54, 'Залив на «Ґітхаб» останній коміт, зробив його, базуючись на даних з Вікіпедії, означеннях з "Вікшинарі" та відео з “ютуба”.', 'Залив на ґітхаб останній коміт, зробив його, базуючись на даних з вікіпедії, означеннях з вікшинарі та відео з ютуба.', [correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [54, 'ДАНІ З «РЕДДІТА», АНАЛІЗ "БЛОГСПОТУ"', 'ДАНІ З РЕДДІТА, АНАЛІЗ БЛОГСПОТУ', [correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [54, 'ТВІТТЕР випереджає Яндекс', 'ТВІТЕР випереджає яндекс', [correctionTypes.MISTAKE, correctionTypes.UNSURE]],
  [54, 'На Фейсбуці знайшлося посилання на блог Ібея.', 'На фейсбуці знайшлося посилання на блог «Ібея».', [correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [54, 'І написання Бінг, і написання Бінґ мають спрацювати.', 'І написання бінг, і написання бінґ мають спрацювати.', [correctionTypes.UNSURE, correctionTypes.UNSURE]],
  ...
  [58, 'Приїхав у город на «Нісані»...', 'Приїхав у город на «нісані»...', correctionTypes.UNSURE],
  [58, 'Прилетіла, "Боїнг" її привіз.', 'Прилетіла, "боїнг" її привіз.', correctionTypes.UNSURE],
  [58, '“Роллс-Ройс” білий, “Роллс-Ройс” синій, “Ролс-Ройс” блакитний та “Роллс-ройс” червоний. “Роллс-ройс” золотистий. “Роллс-Ройс” прозорий.', '“Роллс-ройс” білий, “роллс-ройс” синій, “ролс-ройс” блакитний та “роллс-ройс” червоний. “Роллс-ройс” золотистий. “Роллс-ройс” прозорий.', [correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [58, 'Як і „Як“!', 'Як і „як“!', correctionTypes.UNSURE],
  [58, 'Вийшов із «Х’юндая».', 'Вийшов із «х’юндая».', correctionTypes.UNSURE],
  [58, 'Сіла в "Х\'юндай"!', 'Сіла в "х’юндай"!', correctionTypes.UNSURE],
  [58, 'З «Таврії» відразу по «Аеробусах»?..', 'З «таврії» відразу по «аеробусах»?..', [correctionTypes.UNSURE, correctionTypes.UNSURE]],
  [58, 'Літак "Ту" підлетів до "Ауді" по "Майбасі".', 'Літак "ту" підлетів до "ауді" по "майбасі".', [correctionTypes.UNSURE, correctionTypes.UNSURE, correctionTypes.UNSURE]],
