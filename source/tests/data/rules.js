...
export const tests = [
  ...
  [54, 'Користувач твіттера, проаналізувавши дані з "Гугла", заявила: "не вірю "Твіттеру і Гуглу".', 'Користувач твітера, проаналізувавши дані з ґуґла, заявила: "не вірю "твітеру і ґуґлу".', [correctionTypes.MISTAKE, correctionTypes.MISTAKE, correctionTypes.MISTAKE, correctionTypes.MISTAKE, correctionTypes.UNCERTAIN, correctionTypes.UNCERTAIN, correctionTypes.UNCERTAIN], false, 2],
  ...
  [54, 'ДАНІ З «РЕДДІТА», АНАЛІЗ "БЛОГСПОТУ"', 'ДАНІ З РЕДДІТА, АНАЛІЗ БЛОГСПОТУ', [correctionTypes.UNCERTAIN, correctionTypes.UNCERTAIN]],
  ...
  [_, 'Хостинг фото для інстаграму?', 'Хостинг фото для інстаграму?', _],
